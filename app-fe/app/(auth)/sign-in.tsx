...
import { useSessionContext } from "../session"
 ...
 const SignIn = () => {
      ...
      {/* <TouchableOpacity onPress={(handleSendOTP)} className="w-2/3 p-3 m-5 items-center bg-black rounded-xl"> */}
                ...
                <TouchableOpacity className="w-2/3 p-3 m-5 items-center bg-black rounded-xl">
              ...
              <View className="w-full items-center p-5">
                ...
                <TouchableOpacity className="w-2/3 p-3 items-center border border-black rounded-xl">
                    <Text className="">
                        Resend OTP
                    </Text>
                </TouchableOpacity>
