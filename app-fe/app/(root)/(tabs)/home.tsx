  ...
  return (
    <SafeAreaView className="bg-white">
      ...
      <View className="h-full">
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} className="flex flex-row w-full">
          <View className="h-36 aspect-video p-5 bg-black rounded-xl mr-5">
